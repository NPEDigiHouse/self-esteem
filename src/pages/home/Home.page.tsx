    ...
    <MainLayout>
      <Stack className="">
        ...
        <ParagraphWithImage2
          ...
          paragraph2="Penting untuk diingat bahwa self-esteem dapat berkembang dan berubah seiring waktu. Dengan pemahaman yang lebih baik tentang self-esteem dan upaya untuk memperkuatnya, kita dapat membangun kepercayaan diri yang lebih sehat dan positif. Kuesioner self-esteem kami dirancang untuk membantu Anda mengidentifikasi tingkat self-esteem Anda dan memberikan panduan serta saran untuk meningkatkannya. Dengan meningkatkan self-esteem, Anda dapat mencapai potensi terbaik Anda, mengatasi rintangan, dan hidup dengan lebih percaya diri dan bahagia."
        />
        <HomeExplore />
      </Stack>
    </MainLayout>
