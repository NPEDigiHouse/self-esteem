...
const PersonalityTestJumbotron: React.FC<IPersonalityTestJumbotron> = ({}) => {
  return (
    <Stack className="self-center mb-20 w-full gap-0 pb-2">
      <Stack className="self-center bg-test bg-cover bg-center relative w-fit">
        <Stack className="gap-6 w-[70%] px-10 self-center z-10 my-16 pb-12 pt-10 bg-white/[0.9] ">
          <Stack className="gap-0 items-center z-10">
            <Text className="font-roboto text-[50px] text-primary-text-500 z-10 text-center rounded-xl">
