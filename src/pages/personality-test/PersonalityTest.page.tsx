  ...
  return (
    <MainLayout>
      <Stack className="mb-16 relative">
        <AlertModal opened={true} setOpened={()=>{}} title="Akhiri Tes Kecemasan?" description={"asd"} />
        <QuestionModal
        ...
        >
          {progressCount != 0 && (
            <div className="w-1/2 self-center py-1 px-2 bg-secondary-500 rounded-full fixed bottom-6 z-[100]">
              <Slider
                ...
                labelAlwaysOn
                label={(value) =>
                  `${value == 100 ? value : value.toFixed(1)} %`
                }
                color="gray"
                styles={{
                  root: {}
          ...
          <Button
            ...
            onClick={() => {
              ...
              let percentage = (sumScoreArr / (QuestionPack.length * 4)) * 100;
